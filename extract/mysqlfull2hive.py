...
def mysqlfullimport(src_db, src_table, dst_db, dst_table, etl_mode, res_query, mapper_nums):
...
if __name__ == '__main__':
    sqoop_cmd = generate_sqoop_cmd('hera', 'ods', 'ods_hera_job_df', 'mysql-full', 'select 1', 1)
    ## mysqlfullimport('hera', 'hera_job', 'ods', 'ods_hera_job_df', 'mysql-full','select 1')
